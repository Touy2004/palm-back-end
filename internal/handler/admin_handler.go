...
func (h *AdminHandler) CreateUser(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusBadRequest, "We couldn't create the user. Please check the provided details.", err.Error())
	}
...
func (h *AdminHandler) GetUserByID(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusNotFound, "The user you are looking for could not be found.", err.Error())
	}
...
func (h *AdminHandler) UpdateUser(c *fiber.Ctx) error {
	...
	if err := c.BodyParser(&input); err != nil {
		return response.Error(c, fiber.StatusBadRequest, "Please check your update data. Some fields might be invalid.", err.Error())
	}

	user, err := h.adminService.UpdateUser(id, input)
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't update the user. Please try again.", err.Error())
	}
...
func (h *AdminHandler) DeleteUser(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't delete the user. Please try again.", err.Error())
	}
...
func (h *AdminHandler) SearchUsers(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We encountered an issue searching for users.", err.Error())
	}
	return response.Success(c, fiber.StatusOK, "Users retrieved successfully", users)
}
...
func (h *AdminHandler) GetDevices(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We encountered an issue fetching the devices.", err.Error())
	}
...
func (h *AdminHandler) CreateDevice(c *fiber.Ctx) error {
	...
	if err := c.BodyParser(&device); err != nil {
		return response.Error(c, fiber.StatusBadRequest, "Please fill out all required device fields correctly.", err.Error())
	}

	err := h.adminService.CreateDevice(&device)
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't create the device. Please try again.", err.Error())
	}
...
func (h *AdminHandler) UpdateDevice(c *fiber.Ctx) error {
	...
	var input map[string]interface{}
	if err := c.BodyParser(&input); err != nil {
		return response.Error(c, fiber.StatusBadRequest, "Please check your device update data.", err.Error())
	}

	device, err := h.adminService.UpdateDevice(id, input)
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't update the device. Please try again.", err.Error())
	}
...
func (h *AdminHandler) GetAttendanceHistory(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We encountered an issue fetching the attendance history.", err.Error())
	}
...
func (h *AdminHandler) GetUserAttendanceHistory(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We encountered an issue fetching this user's attendance.", err.Error())
	}
...
func (h *AdminHandler) GetUserPalmTemplates(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We encountered an issue fetching this user's palm templates.", err.Error())
	}
...
func (h *AdminHandler) DeleteUserPalmTemplate(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't delete this palm template.", err.Error())
	}
...
func (h *AdminHandler) GetDashboardSummary(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't load the dashboard summary right now.", err.Error())
	}
...
func (h *AdminHandler) GetReports(c *fiber.Ctx) error {
	...
	if err != nil {
		return response.Error(c, fiber.StatusInternalServerError, "We couldn't generate the reports right now.", err.Error())
	}
